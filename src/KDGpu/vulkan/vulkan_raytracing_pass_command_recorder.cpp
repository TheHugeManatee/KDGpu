...
void VulkanRayTracingPassCommandRecorder::bindDescriptorBuffers(std::span<const DescriptorBufferBinding> bindings) const
{
...
void VulkanRayTracingPassCommandRecorder::setDescriptorBufferOffsets(const Handle<PipelineLayout_t> &pipelineLayout,
                                                                     uint32_t firstSet,
